...
sequenceDiagram
    ...
    note over Server: Verify and spend token_id
    note over Server: Generate statechain_id
    Server->>Enclave: /get_public_key {statechain_id}
