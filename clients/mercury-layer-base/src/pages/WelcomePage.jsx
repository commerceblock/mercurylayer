      ...
      >
        ...
        <div className="self-stretch flex flex-row items-center justify-center py-0 px-[25px] text-[16.1px] text-dimgray-200">
          <div className="flex-1 relative" data-cy="welcome-description">
            If you’re using Mercury Layer for the first time, create a new
            wallet. If you have an existing wallet, load the wallet from your
            device storage, or use your seed phrase or backup file to restore
            the wallet.
          </div>
        </div>
        <div className="self-stretch flex flex-row flex-wrap items-center justify-center py-5 px-2.5 gap-[50px] text-sm">
          ...
          >
            ...
            />
            <div
              className="relative tracking-[-0.02em] leading-[19px]"
              data-cy="load-wallet-label"
            >
              Load wallet
            </div>
          </div>
