const DepositBTCContainer = ({ onBackButtonContainerClick }) => {
  return (
    <div className="self-stretch h-[121px] flex flex-col items-center justify-start py-0 px-2.5 box-border text-left text-5xl text-black font-body">
      <div className="self-stretch flex-1 shadow-[0px_2px_2px_rgba(0,_0,_0,_0.25)] flex flex-col items-start justify-between">
...
export default DepositBTCContainer;
