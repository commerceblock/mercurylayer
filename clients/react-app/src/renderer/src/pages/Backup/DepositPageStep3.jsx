...
import DepositPositionDeposit1 from "../components/DepositPositionDeposit1";
import DepositBTCWindow from "../components/DepositBTCWindow";

const DepositPageStep3 = () => {
    ...
    <div className="w-full relative bg-whitesmoke h-[926px] flex flex-col items-center justify-start gap-[33px]">
      ...
      <div className="self-stretch flex-1 flex flex-row items-center justify-between p-2.5">
        <div className="self-stretch flex-1 rounded-8xs overflow-hidden flex flex-row items-center justify-between py-[21px] px-3.5">
          <DepositPositionDeposit1 />
        </div>
      </div>
      <div className="self-stretch h-[448px] flex flex-col items-center justify-center p-2.5 box-border gap-[10px]">
        <DepositBTCWindow />
        <DepositBTCWindow />
      </div>
...
export default DepositPageStep3;
