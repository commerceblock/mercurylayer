...
import SendStatecoinsInfoPanel from "../components/SendStatecoinsInfoPanel";
...
const SendPage = () => {
  ...
  return (
    <div className="w-full relative bg-whitesmoke h-[926px] overflow-hidden flex flex-col items-center justify-start gap-[25px]">
      <NavBar
